    ...
    return (
        <Dashboard>
            ...
            <Sidebar>
                ...
                <NavItem text="Report" icon="fas fa-envelope-open-text" onClick={ () => navigate("content", "list-client-messages") }/>
                ...
                <NavItem text="Recipients" icon="fas fa-mobile-retro" onClick={ () => navigate("content", "list-client-message-recipients") }/>
                ...
                <NavItem text="Upload Document" icon="fas fa-file-arrow-up" onClick={ () => navigate("content", "upload-file") }/>
                <NavItem text="Documents" icon="fas fa-folder-tree" onClick={ () => navigate("content", "client-files") }/>
                <NavItem text="Complaints" icon="fas fa-box-tissue" onClick={ () => navigate("content", "list-client-tickets") }/>
                <NavItem text="Support Team" icon="fas fa-truck-medical" onClick={ () => navigate("content", "add-ticket") }/>
