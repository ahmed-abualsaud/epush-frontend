...
const AddNotificationSendingHandler = () => {
    ...
    const setChosenHandler = (handler) => {
        navigate("notification-management", "add-notification-sending-template", handler)
    }
...
export default AddNotificationSendingHandler