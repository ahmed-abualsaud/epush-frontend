...
const ListMessages = () =>
{
    ...
    const updateMessageHandler = (message) => {
        navigate("content", "edit-message", message)
    }
            ...
            <Table>
                ...
                <TableBody>
                    <DataRows columns={columns} rows={messages.data.map(message => {
                        ...
                        // message.max_characters = message.language?.max_characters_length ?? "NULL"
                        // message.split_length = message.language?.split_characters_length ?? "NULL"
